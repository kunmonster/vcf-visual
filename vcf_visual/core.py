...
from .utils import save_fig,ALLOWED_VARIABLES,check_variable_type
...
def plot_save(vcf_file:str,exp:str,plot_path:str,plot_type:str,plot_title:str=None,file_type:str=None):
    ...
    # TODO: 检查x,y字段是否在vcf文件中,或者这一步直接根据该字段打开vcf文件,考虑stack和filter参数
    
    # 在此处直接形成fields列表,方便后续进行数据处理

    
    plot_data = get_plot_data(x,y,vcf_file=vcf_file)
